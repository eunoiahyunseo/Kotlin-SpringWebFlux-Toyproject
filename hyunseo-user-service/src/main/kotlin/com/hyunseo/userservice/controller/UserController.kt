package com.hyunseo.userservice.controller

import com.hyunseo.userservice.model.*
import com.hyunseo.userservice.service.UserService
...
class UserController(
    ...
    suspend fun get(
        ...
        // Authorization 에 들어있는 jwt 토큰의 정보로 유저의 정보를 불러온다.
    ...
    suspend fun edit(
        ...
        @AuthToken token: String,
        @RequestPart("profileUrl") filePart: FilePart // multipart form data
    ) {
